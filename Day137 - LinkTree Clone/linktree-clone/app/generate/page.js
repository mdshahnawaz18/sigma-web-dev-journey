        ...
        <div className="item">
          ...
          {links && links.map((item, index) => {
            return <div key={index} className='mx-4'>
              ...
              <input value={item.link || ""} onChange={e => { handleChange(index, e.target.value, item.linktext) }} className='px-4 py-2 mx-2 my-2 focus:outline-pink-500 rounded-full' type="text" placeholder='Enter link' />
            </div>
          })}
