        ...
        <div className='text-white py-14 container mx-auto '>
            ...
            <div className='social-login-buttons'>
                <div className="flex flex-col items-center gap-2 min-h-screen p-10">
                    ...
                    <button onClick={() => { signIn("github") }} className="w-64 flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999XxmlnsXlink"
